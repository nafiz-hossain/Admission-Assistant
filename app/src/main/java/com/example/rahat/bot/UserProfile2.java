...
public class UserProfile2 {
    ...
    public UserProfile2(String name, String email, String phone, String userID, String profilePicUrl) {
        this.name = name;
        this.email = email;
        this.phone = phone;
        this.userID = userID;
    ...
    public UserProfile2(String name, String email, String phone, String userID, String profilePicUrl, String DOB, String addr, String inst) {
        this.name = name;
        this.email = email;
        this.phone = phone;
        this.userID = userID;
